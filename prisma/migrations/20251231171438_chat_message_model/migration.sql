-- CreateEnum
CREATE TYPE "ChatStatus" AS ENUM ('pending', 'accepted', 'blocked');
...
-- AddForeignKey
ALTER TABLE "Chat" ADD CONSTRAINT "Chat_initiatedBy_fkey" FOREIGN KEY ("initiatedBy") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
